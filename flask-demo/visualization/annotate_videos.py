...
from utils.io import save_video_with_audio
...
def annotate_video(
    ...
    # Step 1: Write raw annotated video
    ...
    # Step 2: Convert to web-safe format
    save_video_with_audio(temp_path, output_path)
    os.remove(temp_path)
